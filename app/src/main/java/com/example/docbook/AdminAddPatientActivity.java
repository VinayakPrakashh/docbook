...
public class AdminAddPatientActivity extends AppCompatActivity {
...
name=uname.getText().toString();
        ...
        StorageReference imageRef = storageRef.child("patients").child(spec).child(name);
...
// Download the image file into a byte array
                        Dialog dialog = new Dialog(AdminAddPatientActivity.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_CODE_IMAGE_PICKER && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            StorageReference imageRef = FirebaseStorage.getInstance().getReference().child("patients").child(spec).child(name);
